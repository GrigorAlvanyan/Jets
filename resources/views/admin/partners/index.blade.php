            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('partners.create')}}">
                                {{method_field('GET')}}
                            ...
                            <table class="table">
                                ...
                                @forelse($partners as $partner)
                                    <tr>
                                        <td>{{$partner->url}}</td>
                                        <td>
                                            {{isset($partner->created_at) ? $partner->created_at->toDateString() : ''}}
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{route('partners.edit', ['partner' => $partner->id])}}">
