                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if(isset($destination))
                                    <form class="form" method="POST" action="{{route('destinations.update', ['destination'=>$destination->id])}}">
                                        {{method_field('PUT')}}
                                        @else
                                     <form class="form" method="POST" action="/admin/destinations">
                                @endif
                                    @csrf
                                    <div class="row">
...
{{--                                        </div>--}}
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title" class="form-control" placeholder="Title" name="title"
                                                       value="{{isset($destination) ? $destination->title : old('title')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="slug" class="form-control" placeholder="Slug" name="slug"
                                                       value="{{isset($destination) ? $destination->slug : old('slug')}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="show_on_home" class="form-control" placeholder="Show On Home" name="show_on_home"
                                                       value="{{isset($destination) ? $destination->show_on_home : old('show_on_home')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="is_top" class="form-control" placeholder="Is top" name="is_top"
                                                       value="{{isset($destination) ? $destination->is_top : old('is_top')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="image_id" class="form-control" placeholder="Image Id" name="image_id"
                                                       value="{{isset($destination) ? $destination->image_id : old('image_id')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="country_id" class="form-control" placeholder="Country Id" name="country_id"
                                                       value="{{isset($destination) ? $destination->country_id : old('country_id')}}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
