                            ...
                            <table class="table">
                                ...
                                @forelse($destinations as $destination)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-pill badge-light-primary mr-1">{{$destination->show_on_home ? 'Yes' : 'No' }}</span>
                                        </td>
                                        <td>
                                            <span class="badge badge-pill badge-light-primary mr-1">{{$destination->is_top ? 'Yes' : 'No' }}</span>
                                        </td>
                                        <td>
                                            {{$destination->summary}}
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <form action="{{route('destinations.destroy', ['destination' => $destination->id])}}" method="POST">
                                                        ...
                                                        <button type="submit" class="dropdown-item" href="{{route('destinations.destroy', ['destination' => $destination->id])}}">
