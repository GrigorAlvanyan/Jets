                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Create Menu Link</h4>
                            </div>

                            <div class="card-body">
                                @include('forms.messages')
                                @if(isset($menuLink))
                                    <form class="form" method="POST" action="{{route('menuLinks.update', ['menuLink'=>$menuLink->id])}}">
                                        {{method_field('PUT')}}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="menu_id" class="form-control" placeholder="Menu Id" name="menu_id"
                                                                   value="{{isset($menuLink) ? $menuLink->menu_id : old('menu_id')}}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label for="parent_id">Parent Id</label>
                                                            <input type="text" id="parent_id" class="form-control" placeholder="Parent Id" name="parent_id"
                                                                   value="{{isset($menuLink) ? $menuLink->v : old('parent_id')}}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="title" class="form-control" placeholder="Title" name="title"
                                                                   value="{{isset($menuLink) ? $menuLink->title : old('title')}}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="status" class="form-control" placeholder="Status" name="status"
                                                                   value="{{isset($menuLink) ? $menuLink->status : old('status')}}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="position" class="form-control" placeholder="Position" name="position"
                                                                   value="{{isset($menuLink) ? $menuLink->position : old('position')}}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="url" class="form-control" placeholder="Url" name="url"
                                                                   value="{{isset($menuLink) ? $menuLink->url : old('url')}}" />
                                                        </div>
                                                    </div>
                                                    @if(isset($menus) && $menus->count())
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="model">Menu</label>
                                                                <select class="form-control" id="cont" name="continent_id">
                                                                    <option default>Select</option>
                                                                    @foreach($menus as $menu)
                                                                        <option value="{{$menu->id}}" {{isset($menuLink) && $menuLink->menu_link == $menu->id ? 'selected' : ''}}>{{$menu->title}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
