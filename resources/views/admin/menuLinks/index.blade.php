                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Menu Links</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{route('menuLinks.create')}}">
                                {{method_field('GET')}}
                            ...
                            <table class="table">
                                ...
                                @forelse($menuLinks as $menuLink)
                                    <tr>
                                        ...
                                        <td>
                                            {{isset($menuLink->created_at) ? $menuLink->created_at->toDateString() : ''}}
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{route('menuLinks.edit', ['menuLink' => $menuLink->id])}}">
                                                        <i data-feather="edit-2" class="mr-50"></i>
                                                        <span>Edit</span>
                                                    </a>
                                                    <form action="{{route('menuLinks.destroy', ['menuLink' => $menuLink->id])}}" method="POST">
                                                        {{method_field('DELETE')}}
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$menuLink->id}}">
