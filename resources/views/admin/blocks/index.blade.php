            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('blocks.create')}}">
                                {{method_field('GET')}}
                            ...
                            <table class="table">
                                ...
                                @forelse($blocks as $block)
                                    <tr>
                                        <td>{{$block->title}}</td>
                                        <td>
                                            {{isset($block->created_at) ? $block->created_at->toDateString() : ''}}
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{route('blocks.edit', ['block' => $block->id])}}">
                                                        <i data-feather="edit-2" class="mr-50"></i>
                                                        <span>Edit</span>
                                                    </a>
                                                    <form action="{{route('blocks.destroy', ['block' => $block->id])}}" method="POST">
                                                        {{method_field('DELETE')}}
                                                        @csrf
