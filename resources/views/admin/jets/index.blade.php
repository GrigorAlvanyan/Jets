                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Jets</h4>
                        </div>
                        <div class="card-body">
                                <form method="POST" action="{{route('jets.create')}}">
                                    {{method_field('GET')}}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @forelse($jets as $jet)
                                    <tr>
                                        <td>
                                            <img src="" class="mr-75" height="20" width="20" alt="Angular" />
                                        </td>
                                        <td>{{$jet->title}}</td>
                                        <td>
                                            {{$jet->slug}}
                                        ...
                                        <td>
                                            <span class="badge badge-pill badge-light-primary mr-1">{{$jet->is_top ? 'Yes' : 'No' }}</span>
                                        </td>
                                        <td>
                                            {{$jet->manufacturer}}
                                        </td>
                                        ...
                                        <td>
                                            {{isset($jet->created_at) ? $jet->created_at->toDateString() : ''}}
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{route('jets.edit', ['jet' => $jet->id])}}">
                                                        <i data-feather="edit-2" class="mr-50"></i>
                                                        <span>Edit</span>
                                                    </a>
                                                    <form action="{{route('jets.destroy', ['jet' => $jet->id])}}" method="POST">
                                                        {{method_field('DELETE')}}
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$jet->id}}">
                                                        <button type="submit" class="dropdown-item" href="{{route('jets.destroy', ['jet' => $jet->id])}}">
